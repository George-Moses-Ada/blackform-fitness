      ...
      <div className="max-w-md w-full mx-4">
        ...
        <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-700 bg-black text-accent-lime focus:ring-accent-lime" />
                <span className="ml-2 text-gray-400 text-sm">Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-accent-lime text-sm hover:underline">
                Forgot password?
              </Link>
            </div>
            <button
          ...
          <p className="mt-8 text-center text-gray-400 text-sm">
            ...
            <Link to="/signup" className="text-accent-lime hover:underline">
              Sign up
            </Link>
          </p>
        </div>
